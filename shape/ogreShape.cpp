...
void OgreShape::setupAnimations()
	{
...
void OgreShape::fadeAnimations(Real deltaTime)
{
	for (int i = 0; i < NUM_ANIMS; i++)
	{
		if (mFadingIn[i])
...
void OgreShape::setBaseAnimation(AnimID id, bool reset)
{
...
void OgreShape::setTopAnimation(AnimID id, bool reset)
{
